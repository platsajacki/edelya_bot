...
HOW_IT_WORKS_FINAL_MESSAGE = (
    'Не нужно составлять идеальное меню сразу.\n\n'
    'Начните с одного блюда: добавьте его в план на ближайший день, '
    'а Еделя поможет собрать список продуктов для покупок.\n\n'
